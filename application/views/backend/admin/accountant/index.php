...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><?php echo get_phrase('Manage Accountant'); ?></h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/dashboard"><?php echo get_phrase('Dashboard'); ?></a></li>
                <li class="breadcrumb-item active"><?php echo get_phrase('Manage Accountant'); ?></li>
            </ol>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><?php echo get_phrase('New Accountant'); ?></h4>
               
                <?php echo form_open(base_url() . 'admin/accountant/insert/' , array('class' => 'mt-4', 'enctype' => 'multipart/form-data'));?>
                   
                    <div class="form-group">
                        <label for="name"><?php echo get_phrase ('Name');?></label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="<?php echo get_phrase('Enter Name');?>">
                        <input type="hidden" name="accountant_number" value="<?php echo substr(md5(uniqid(rand(), true)), 0, 10);?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="custom-file mb-3">
                        ...
                        <small id="documentHelp" class="form-text text-muted"><?php echo get_phrase('Accountant CV or any document');?></small>
                    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><?php echo get_phrase('List Accountants');?></h4>
                                    ...
                                    <td>
                                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                                <a href="javascript:void(0)" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/accountant-edit_accountant/<?php echo $accountant['accountant_id'];?>')" class="btn btn-secondary"><i class="fa fa-edit"></i></a>
                                                <a href="javascript:void(0)" onclick="confirm_modal('<?php base_url();?>accountant/delete/<?php echo $accountant['accountant_id'];?>')" class="btn btn-secondary"><i class="fa fa-times"></i></a>
                                                <!-- <a href="<?php echo base_url() . 'uploads/accountant_image/' . $accountant['file_name'];?>" class="btn btn-secondary"><i class="fa fa-download"></i></a> -->

                                                <?php if($accountant['file_name'] != '') { ?>
                                                    <a href="<?php echo base_url() . 'uploads/accountant_image/' . $accountant['file_name']; ?>" target="_blank" class="btn btn-secondary"><i class="fa fa-download"></i></a>
                                                <?php } else { ?>
