...
class Teacher_model extends CI_Model
{
    ...
    function insetTeacherFunction(){
        ...
        if ($check_email != null) {
            ...
            move_uploaded_file($_FILES["file_name"]["tmp_name"], "uploads/teaccher_image/" . $_FILES["file_name"]["name"]);    // upload files
            move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/teaccher_image/' . $teacher_id . '.jpg');            // image with user ID
        }
    }
